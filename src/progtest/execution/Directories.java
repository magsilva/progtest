...
public class Directories {
	...
	public static String getCourseDirPath(Assignment assignment) {
		return getStorageDirPath(assignment) + File.separator + LABEL_COURSE
	...
	public static String getPitiDirPath(Assignment assignment) {
		return getOracleDirPath(assignment) + File.separator + DIR_PITI;
	}
	...
	public static String getToolOutputDirPath(File outputDir, Tool tool) {
	...
	public static String getToolReportsDirPath(File outputDir, Tool tool) {
		return getToolOutputDirPath(outputDir, tool) + File.separator
				+ DIR_REPORTS;
	}
	...
	public static String getToolTempDirPath(File rootDir, Tool tool) {
		return rootDir.getPath() + File.separator + LABEL_TOOL + tool.getIdCode();
	}

	public static String getSrcDirPath(File rootDir, Tool tool) {
		return getToolTempDirPath(rootDir, tool) + File.separator + DIR_SRC;
	}

	public static String getBinDirPath(File rootDir, Tool tool) {
		return getToolTempDirPath(rootDir, tool) + File.separator + DIR_BIN;
	}

	public static String getProgDirPath(File rootDir, Tool tool) {
		return getToolTempDirPath(rootDir, tool) + File.separator + DIR_PROG;
	}

	public static String getTestDirPath(File rootDir, Tool tool) {
		return getToolTempDirPath(rootDir, tool) + File.separator + DIR_TEST;
	}

	public static String getInstDirPath(File rootDir, Tool tool) {
		return getToolTempDirPath(rootDir, tool) + File.separator + DIR_INST;
	}

	public static String getLibDirPath(File rootDir, Tool tool) {
		return getToolTempDirPath(rootDir, tool) + File.separator + DIR_LIB;
	}

	public static String getTmpDirPath(File rootDir, Tool tool) {
		return getToolTempDirPath(rootDir, tool) + File.separator + DIR_TMP;
	}

	public static String getRptDirPath(File rootDir, Tool tool) {
		return getToolTempDirPath(rootDir, tool) + File.separator + DIR_RPT;
	}

	public static String getOutFilePath(File rootDir, Tool tool) {
		return getToolTempDirPath(rootDir, tool) + File.separator + FILE_OUT;
	}
