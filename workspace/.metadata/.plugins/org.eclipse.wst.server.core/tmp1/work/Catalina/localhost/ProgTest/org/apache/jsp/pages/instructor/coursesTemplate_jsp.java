...
public final class coursesTemplate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_f_005floadBundle_005f0(PageContext _jspx_page_context)
    ...
    // /pages/instructor/coursesTemplate.jsp(7,58) name = var type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_f_005floadBundle_005f0.setVar("msg");
    // /pages/instructor/coursesTemplate.jsp(7,58) name = basename type = javax.el.ValueExpression reqTime = false required = false fragment = false deferredValue = true expectedTypeName = java.lang.String deferredMethod = false methodSignature = null
    _jspx_th_f_005floadBundle_005f0.setBasename(new org.apache.jasper.el.JspValueExpression("/pages/instructor/coursesTemplate.jsp(7,58) 'resources.Messages'",_el_expressionfactory.createValueExpression("resources.Messages",java.lang.String.class)));
  ...
  private boolean _jspx_meth_tiles_005finsertDefinition_005f0(PageContext _jspx_page_context)
    ...
    // /pages/instructor/coursesTemplate.jsp(9,57) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_tiles_005fputAttribute_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_005finsertDefinition_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_tiles_005finsertDefinition_005f0)
    ...
    // /pages/instructor/coursesTemplate.jsp(10,55) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_tiles_005fputAttribute_005f0.setValue(new String("ProgTest"));
    // /pages/instructor/coursesTemplate.jsp(10,55) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_tiles_005fputAttribute_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_005finsertDefinition_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_tiles_005finsertDefinition_005f0)
    ...
    // /pages/instructor/coursesTemplate.jsp(12,44) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_tiles_005fputAttribute_005f1.setValue(new String("/pages/instructor/courses.jsp"));
    // /pages/instructor/coursesTemplate.jsp(12,44) name = type type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_tiles_005fputAttribute_005f1.setType("template");
    // /pages/instructor/coursesTemplate.jsp(12,44) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
