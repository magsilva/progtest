...
public final class allAssignmentsTemplate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_f_005floadBundle_005f0(PageContext _jspx_page_context)
    ...
    // /pages/student/allAssignmentsTemplate.jsp(7,58) name = var type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_f_005floadBundle_005f0.setVar("msg");
    // /pages/student/allAssignmentsTemplate.jsp(7,58) name = basename type = javax.el.ValueExpression reqTime = false required = false fragment = false deferredValue = true expectedTypeName = java.lang.String deferredMethod = false methodSignature = null
    _jspx_th_f_005floadBundle_005f0.setBasename(new org.apache.jasper.el.JspValueExpression("/pages/student/allAssignmentsTemplate.jsp(7,58) 'resources.Messages'",_el_expressionfactory.createValueExpression("resources.Messages",java.lang.String.class)));
  ...
  private boolean _jspx_meth_tiles_005finsertDefinition_005f0(PageContext _jspx_page_context)
    ...
    // /pages/student/allAssignmentsTemplate.jsp(9,54) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_tiles_005fputAttribute_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_005finsertDefinition_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_tiles_005finsertDefinition_005f0)
    ...
    // /pages/student/allAssignmentsTemplate.jsp(10,55) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_tiles_005fputAttribute_005f0.setValue(new String("ProgTest"));
    // /pages/student/allAssignmentsTemplate.jsp(10,55) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_tiles_005fputAttribute_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_tiles_005finsertDefinition_005f0, PageContext _jspx_page_context, int[] _jspx_push_body_count_tiles_005finsertDefinition_005f0)
    ...
    // /pages/student/allAssignmentsTemplate.jsp(12,48) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_tiles_005fputAttribute_005f1.setValue(new String("/pages/student/allAssignments.jsp"));
    // /pages/student/allAssignmentsTemplate.jsp(12,48) name = type type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_tiles_005fputAttribute_005f1.setType("template");
    // /pages/student/allAssignmentsTemplate.jsp(12,48) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
