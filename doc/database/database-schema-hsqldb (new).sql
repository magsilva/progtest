...
CREATE TABLE assignment_criterion (
	...
	weight INT,
	CONSTRAINT PK_assignment_criterion PRIMARY KEY (course, assignment, criterion),
	CONSTRAINT FK_assignment_criterion_assignment FOREIGN KEY (course, assignment) REFERENCES Assignment (course, idCode),
	CONSTRAINT FK_assignment_criterion_criterion FOREIGN KEY (criterion) REFERENCES Criterion (idCode)
);
